...
import time, os, signal, glob, subprocess
...
def	button_trigger():
	...
	while True:
		...
		if buttonStatus == 2:
			...
			#MS.play_file("/home/pi/autorun/py_script/data/block_coding_ment.wav")
			#MS.play_file("/home/pi/autorun/py_script/data/block_coding_ment2.wav")
